...
public class SuDam extends JFrame {
    ...
    public SuDam() throws IOException {

        setTitle("수정");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //종료버튼 활성화
        setContentPane(new MySuDamPanel());
        ...
        hwa.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Modify.r2.set(Modify.rowIndex, input.getText());

                Modify.model.clear();

                for (Object st : Modify.r2) {
                ...
                try {
                    Modify.saveFile("dambae.txt", Modify.r2);
    ...
    class MySuDamPanel extends JPanel {
