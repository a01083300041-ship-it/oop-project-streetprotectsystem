 ...
 * @author 조은진
 */
public class InsertTrash extends JFrame {
    ...
    public InsertTrash() {
        ...
        setContentPane(new MyinsertTrashPanel());
        ...
        input2.setBounds(110, 127, 200, 23);
        ...
        hwa.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Object str = input2.getText();
                Modify.model.addElement(str);

                Modify.r1.add(str.toString());

                Modify.model.clear();

                for (Object st : Modify.r1) {
                    Modify.model.addElement(st);
                }
    ...
    class MyinsertTrashPanel extends JPanel {
